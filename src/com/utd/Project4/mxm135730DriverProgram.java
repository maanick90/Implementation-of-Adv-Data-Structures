...
public class mxm135730DriverProgram {
	 ...
	 */
	 private static String fnGetValue(Map<Character, String> map, String[] temp1, String pattern) {
		...
		String str2 = map.get(temp1[1].split("\\"+pattern)[1].charAt(0));		// get var2
		LinkedList<Integer> tempList;
		
		if(pattern.equals("+"))
			tempList = mxm135730OperationFunctions.addLists(mxm135730OperationFunctions.StrToNum(str1), mxm135730OperationFunctions.StrToNum(str2));		// call addition function
		else if(pattern.equals("-"))
			tempList = mxm135730OperationFunctions.subtractLists(mxm135730OperationFunctions.StrToNum(str1), mxm135730OperationFunctions.StrToNum(str2));	// call subtraction function
		else if(pattern.equals("*"))
			tempList = mxm135730OperationFunctions.multiplyLists(mxm135730OperationFunctions.StrToNum(str1), mxm135730OperationFunctions.StrToNum(str2));	// call multiplication function
		else
			tempList = mxm135730OperationFunctions.powerLists(mxm135730OperationFunctions.StrToNum(str1), mxm135730OperationFunctions.StrToNum(str2));	// call power function
			
		return mxm135730OperationFunctions.NumToStr(tempList);									// return the String value (list converted to String)
	}
